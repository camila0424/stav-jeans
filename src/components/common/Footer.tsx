  ...
  return (
    <footer className="bg-navy text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-3 gap-10">
        <div>
          <h2 className="font-heading text-2xl tracking-wider mb-3">STAV JEANS</h2>
          <p className="text-sm text-white/70 leading-relaxed">
            Moda femenina con identidad propia. Calidad, estilo y comodidad en cada prenda.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-white/70">
            ...
            <li>
              <a
                href="https://instagram.com/stavjeans"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 hover:text-yellow transition-colors"
              >
      ...
      <div className="border-t border-white/10 text-center text-xs text-white/40 py-4">
        © {new Date().getFullYear()} Stav Jeans. Todos los derechos reservados.
      </div>
    </footer>
  );
}
