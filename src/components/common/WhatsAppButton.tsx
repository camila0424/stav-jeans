  ...
  return (
    ...
    >
      <div className="relative w-14 h-14">
        ...
        {/* Círculo principal */}
        <div className="relative w-14 h-14 rounded-full bg-[#25D366] flex items-center justify-center shadow-lg shadow-black/25 group-hover:scale-110 transition-transform duration-300">
