...
const RECENT_ORDERS = [
  { id: '#1024', customer: 'María García', date: '28 may 2026', total: '$89.900', status: 'confirmed' },
  { id: '#1023', customer: 'Laura Torres', date: '27 may 2026', total: '$45.000', status: 'shipped' },
  { id: '#1022', customer: 'Valentina Ruiz', date: '26 may 2026', total: '$130.000', status: 'delivered' },
  { id: '#1021', customer: 'Sofía López', date: '25 may 2026', total: '$67.500', status: 'pending' },
];
...
function AdminDashboard() {
  return (
    <div className="p-8">
      ...
      <p className="text-sm text-gray-500 font-body mb-8">Resumen de mayo 2026</p>
            ...
            {RECENT_ORDERS.map(order => {
              ...
              return (
                <tr key={order.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 text-gray-700 font-medium">{order.total}</td>
